...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vueHead = __webpack_require__(53);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _headerTheme = __webpack_require__(22);

	var _headerTheme2 = _interopRequireDefault(_headerTheme);

	var _footerTheme = __webpack_require__(25);
	    ...
	    getDefines: function getDefines() {
	      ...
	      this.$http.get('wp-json/defines/v2/info/').then(function (response) {
	        ...
	        _router2.default.beforeEach(function (to, from, next) {
	          (0, _jquery2.default)('.content').css('min-height', window.innerHeight + 'px');
	          next();
	        });
	        _this.setRoutesForWidget();
	      }, function (response) {
	    ...
	    setRoutes: function setRoutes(data) {
	      ...
	      data.forEach(function (route, index) {
	        array.push({
	          name: route.name,
	          path: route.path,
	          component: __webpack_require__(29)("./" + route.component + '.vue'),
	          meta: {
	    ...
	    setRoutesForWidget: function setRoutesForWidget() {
	      ...
	      if (typeof menuLinks != 'undefined' && menuLinks != null) {
	        Array.from(menuLinks.children).forEach(function (el) {
	          ...
	          a.href = path.replace(_this2.variables.siteUrl, '');
	          a.addEventListener('click', function (e) {
	            e.preventDefault();
	            var routeName = e.srcElement.getAttribute('href').replace(/\//g, '');
	            _this2.$router.push({ name: routeName });
	          });
	        });
	      }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-bfc4e2ca", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-bc452fae", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/var/www/bpevents/wp-content/themes/Vue/views/Contact.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-7555e1d8", Component.options)
	  } else {
	    hotAPI.reload("data-v-7555e1d8", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jqueryToastPlugin = __webpack_require__(33);

	var _jqueryToastPlugin2 = _interopRequireDefault(_jqueryToastPlugin);
	...
	exports.default = {
	  ...
	  methods: {
	    sendMessage: function sendMessage(event) {
	      ...
	      if (this.checkData() && this.validateData()) {
	        ...
	        this.$http.post('' + this.defines.siteUrl + '/wp-admin/admin-ajax.php', {
	          ...
	          _jquery2.default.toast().reset('all');
	          _jquery2.default.toast({
	    ...
	    validateData: function validateData() {
	      ...
	      (0, _helper.isMail)(email) ? this.validate.emailIsValid = true : this.validate.emailIsValid = false;
	      (0, _helper.isName)(name) ? this.validate.nameIsValid = true : this.validate.nameIsValid = false;
	      (0, _helper.isSafe)(topic) ? this.validate.topicIsValid = true : this.validate.topicIsValid = false;
	      (0, _helper.isSafe)(message) ? this.validate.messageIsValid = true : this.validate.messageIsValid = false;

	      for (var key in this.validate) {
	        var value = this.validate[key];
	        if (!value) {
	          result = false;
	          _jquery2.default.toast().reset('all');
	          _jquery2.default.toast({
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    class: {
	      'form-error': !_vm.validate.nameIsValid
	    },
	    attrs: {
	      "type": "text",
	    ...
	    class: {
	      'form-error': !_vm.validate.topicIsValid
	    },
	    attrs: {
	      "type": "text",
	    ...
	    class: {
	      'form-error': !_vm.validate.emailIsValid
	    },
	    attrs: {
	      "type": "email",
	      "placeholder": "E-mail"
	    ...
	    class: {
	      'form-error': !_vm.validate.messageIsValid
	    },
	    attrs: {
	      "placeholder": "Masz pytania? Pisz śmiało ;)"
	    },
	    domProps: {
	      "value": _vm._s(_vm.data.message)
	    },
	    on: {
	      "input": function($event) {
	        if ($event.target.composing) { return; }
	        _vm.data.message = $event.target.value
	      }
	    }
	  }), _c('br'), _vm._v(" "), _c('input', {
	    attrs: {
	  ...
	  })]), _vm._v("\n  " + _vm._s(_vm.data)), _c('br'), _vm._v("\n  " + _vm._s(_vm.validate) + "\n")])
	},staticRenderFns: []}
	module.exports.render._withStripped = true
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-7555e1d8", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _slickCarousel = __webpack_require__(37);
	  ...
	  methods: {
	    getDataEq: function getDataEq() {
	      ...
	      this.$http.get('/wp-json/acf/v2/post/' + this.defines.galleryPage).then(function (response) {
	        ...
	        _this.getSlides();
	        setTimeout(function () {
	          (0, _jquery2.default)('#eq-slider').slick();
	        }, 0);
	      }, function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_c('h1', [_vm._v("Galeria")]), _vm._v(" "), _c('div', {
	    attrs: {
	      "id": "eq-slider"
	    }
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-1a6b67ec", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    setDataSlider: function setDataSlider() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/var/www/bpevents/wp-content/themes/Vue/components/slider.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-460b1073", Component.options)
	  } else {
	    hotAPI.reload("data-v-460b1073", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var update = __webpack_require__(44)("2392ae18", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js?{\"id\":\"data-v-460b1073\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./slider.vue", function() {
	     var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js?{\"id\":\"data-v-460b1073\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./slider.vue");
	...
	exports.default = {
	  ...
	  methods: {
	    getSlides: function getSlides() {
	      var el = this.$el;
	      setTimeout(function () {
	        (0, _jquery2.default)(el).not('.slick-initialized').slick();
	      }, 0);

	      (0, _jquery2.default)(el).on('init', function () {
	        (0, _jquery2.default)(el).removeClass('unvisible');
	      });
	    }
	  },
	  watch: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('div', {
	      ...
	      attrs: {
	        "to": {
	          name: slide.slide_link
	        }
	      }
	    }, [_vm._v(_vm._s(slide.slide_btn_text))])], 1), _vm._v(" "), _c('img', {
	      staticClass: "img-responsive",
	      attrs: {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-460b1073", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_c('keep-alive', [_c('slider', {
	    attrs: {
	      "slides": this.slides
	    }
	  })], 1)], 1), _vm._v(" "), (_vm.offers) ? _c('section', {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-19b04e52", module.exports)
	  }
	}
...
/***/ function(module, exports) {
	...
	exports.default = {
	  ...
	  head: {
	    ...
	    meta: function meta() {
	      return [{ name: 'description', content: this.$route.meta.desc }];
	    }
	  },
	  data: function data() {
	    return {
	  ...
	  methods: {
	    ...
	    getDataEq: function getDataEq() {
	      ...
	      this.$http.get('/wp-json/acf/v2/post/' + this.defines.referencesPage).then(function (response) {
	        _this.refs = response.body.acf.opinion;
	      }, function (response) {
	        console.log('Data could not be loaded', +response);
	      });
	    },
	    ...
	    modifyDate: function modifyDate(s) {
	      var slash = '/';
	      var r = new RegExp(slash, 'g');
	      s += 'r.';
	      return s.replace(r, '.');
	    }
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }, [_c('h1', [_vm._v("Opinie")]), _vm._v(" "), _c('div', {
	    attrs: {
	      "id": "refs"
	    }
	    ...
	    return _c('div', {
	      ...
	      staticClass: "img-responsive",
	      attrs: {
	        "src": ref.ref_autor_img.url,
	        "alt": ref.ref_autor_img.alt
	      }
	    }), _vm._v(" "), _c('h2', [_vm._v(_vm._s(ref.ref_autor))]), _vm._v(" "), _c('p', {
	      domProps: {
	        "innerHTML": _vm._s(ref.ref_opinion)
	      }
	    }), _vm._v(" "), _c('span', {
	      domProps: {
	        "innerHTML": _vm._s(_vm.modifyDate(ref.ref_data))
	      }
	    })])
	  })], 2)])
	},staticRenderFns: []}
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-31b86a00", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }, [_c('header-theme'), _vm._v(" "), _c('transition', {
	    attrs: {
	      "name": "slide-fade",
	      "mode": "out-in"
	    }
	    ...
	    attrs: {
	      "defines": this.variables
	    }
	  })], 1), _vm._v(" "), _c('footer-theme', {
	    attrs: {
	      "defines": this.variables
	    }
	  }), _vm._v(" "), _c('div', {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-2cabda8c", module.exports)
	  }
	}
